# CIFAR-100 / ConViT-Tiny / KD result
...
| Vanilla Top-1 | 74.87% |
| KD best Top-1 | **73.59%** |
| Gain over Vanilla | **-1.28pp** |
| Best epoch | 266 |
| Latest Top-1 | 73.42% |
| Elapsed time | 3h 28m 33s |

The best checkpoint, not the epoch-300 latest checkpoint, is the selected
student result. The fixed teacher is 6.19pp below the Vanilla ConViT result, so
...
- `training.log`: complete H200 log from job `bapedragon_395`
